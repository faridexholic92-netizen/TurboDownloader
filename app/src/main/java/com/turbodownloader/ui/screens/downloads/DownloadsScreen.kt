            ...
            TabRow(
                ...
                tabs.forEachIndexed { index, title ->
                    Tab(
                        ...
                        icon = {
                            Icon(
                                imageVector = if (index == 0) Icons.Default.Downloading else Icons.Default.DownloadDone,
            ...
            HorizontalPager(
                ...
                if (downloads.isEmpty()) {
                    Column(
                        ...
                        Icon(
                            imageVector = if (page == 0) Icons.Default.CloudQueue else Icons.Default.CheckCircle,
                            contentDescription = null,
                        ...
                        Text(
                            text = if (page == 0) "No active downloads" else "No completed downloads",
